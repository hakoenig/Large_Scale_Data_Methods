...
# Load data
file_path = os.getcwd().replace("api", "data/iris_data.csv")
...
# Storing the model
rfModel.write().overwrite().save("sparksaves/rfModel")
pipelineModel.write().overwrite().save("sparksaves/pipelineModel")
